...
class source:
    ...
    def sources(self, url, hostDict, hostprDict):
        sources = []
        print "print hdstreams def sources"
        try:
            if not url:
                return sources
            ...
            for e, h, sLang, sName in aResult:
                ...
                if q=='1080p' and e=='1':
                    ...
                    #elif 'nxload' in link:
                        #sources.append({'source': 'nxload.com', 'quality': '1080p', 'language': 'de', 'url': link, 'direct': True, 'debridonly': False})
                    ...
                    if 'openload' in link:
                        ...
                        sources.append({'source': 'streamango.com', 'quality': 'HD', 'language': 'de', 'url': link, 'direct': False, 'debridonly': False})
                    #elif 'nxload' in link:
                        #sources.append({'source': 'nxload.com', 'quality': 'HD', 'language': 'de', 'url': link, 'direct': True, 'debridonly': False})
                    elif 'streamcloud' in link:
                        sources.append({'source': 'streamcloud.com', 'quality': 'SD', 'language': 'de', 'url': link, 'direct': False, 'debridonly': False})
